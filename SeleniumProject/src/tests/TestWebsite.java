...
public class TestWebsite extends BaseClass{
	...
	public void test_01() throws InterruptedException{
		...
		Thread.sleep(5000);
		getWebDriver().findElement(By.xpath("(//A[@class='w3-bar-item w3-button'][text()='Learn Graphics'][text()='Learn Graphics'])[1]")).click();
		Thread.sleep(5000);
		getWebDriver().findElement(By.xpath("//A[@href='svg_intro.asp'][contains(text(),'HTML ')]")).click();
		Thread.sleep(5000);
